...
def simple_socket_test():
    ...
    # tensor_in_blob = socket_conn.recv(1606)
    tensor_in_blob = socket_conn.recv(875)
    
    print("Client received tensor_in_blob: " + str(tensor_in_blob))
    print("   len = " + str(len(tensor_in_blob)))
    my_py_tensor = torch.load(BytesIO(tensor_in_blob))
    print(my_py_tensor)
    print(my_py_tensor.size())

    # tensor_2_in_blob = socket_conn.recv(875)
    # print("Client received tensor_2_in_blob: " + str(tensor_2_in_blob))
    # print("   len = " + str(len(tensor_2_in_blob)))
    # my_py_tensor = torch.load(BytesIO(tensor_2_in_blob))
    # print(my_py_tensor)
