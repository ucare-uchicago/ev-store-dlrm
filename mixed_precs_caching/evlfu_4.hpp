...
class EVLFU_4BIT {
  // TODO: Should use template to handle different precision?
    ...
    // float value_mapping[15] = {0.5, 0.1, 0.07, 0.04, 0.01, 0.001, -0.0001, 0, -0.5, -0.1, -0.07, -0.04, -0.01, -0.001, -0.0001};
    float value_mapping[15] = {1, 0.8, 0.6, 0.4, 0.0625, 0.00390625, 0.0000153, 0, -0.0000153, -0.00390625, -0.0625, -0.4, -0.6, -0.8, -1};
