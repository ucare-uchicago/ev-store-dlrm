...
file1=input_dir."/cpp_algo-cdf.csv"
file2=input_dir."/8bit_direct_io-cdf.csv"
file3=input_dir."/4bit_8bit_direct_io-cdf.csv"
file4=input_dir."/no-drop-caches.csv"

# set terminal qt 1
# set terminal postscript eps enhanced color 22 font ",19"
# outputFile="cdf_evlfu_vs_lru.eps"

set terminal pdf font ",12"
# set terminal pdf font ",21"
outputFile=input_dir."/cdf_direct_io_analysis.pdf"


# set term png
set size 1,1

set style line 1 linecolor rgb "red" lt 1 lw 4
set style line 2 linecolor rgb "blue" lt 1 lw 4
set style line 3 linecolor rgb "green" lt 2 lw 4
set style line 4 linecolor rgb "grey" lt 2 lw 4

set title "CDF latency of different data-reading implementation \n[Mixed precision: 8bit + 4 bit]"
...
plot \
     file1 using 2:1 with lines ls 1 title "drop-caches (every 0.25 s)", \
     file2 using 2:1 with lines ls 2 title "O-DIRECT flag (read 8bit)", \
     file3 using 2:1 with lines ls 3 title "O-DIRECT flag (read 8bit + 4bit)", \
     file4 using 2:1 with lines ls 4 title "no drop-caches", \
